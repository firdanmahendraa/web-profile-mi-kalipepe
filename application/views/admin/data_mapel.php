                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        ...
                        <a class="btn btn-sm btn-danger" href="<?php echo base_url()?>Backend/hapus_mapel/<?php echo $ssw->id_mapel; ?>>">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?php echo base_url('backend/tambah_mapel') ?>" method="post">
  ...
  <div class="modal fade" id="edit-mapel<?php echo $j->id_mapel; ?>">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?php echo base_url('backend/ubah_mapel') ?>" method="post">
            <div class="form-group">
              <label>Mata Pelajaran</label>
